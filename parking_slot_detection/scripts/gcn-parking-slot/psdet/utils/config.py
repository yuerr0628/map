...
def get_args():
    ...
    args.cfg = "/mnt/pool/yhy/ocr_video/src/parking_slot_detection/scripts/gcn-parking-slot/config/ps_gat.yaml"
    args.ckpt = "/mnt/pool/yhy/ocr_video/src/parking_slot_detection/scripts/gcn-parking-slot/model/checkpoint_epoch_200.pth"
    return args
